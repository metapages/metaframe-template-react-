import {fromEuler, Quaternion} from "quaternion";
...
export const createNormalizer = (valuesToCapture : number = 30, scale : number = 1) => {
...
export const rotateEulerFromBaselineQuaternion = (orientation : EulerArray, baselineQuaternion : typeof Quaternion): EulerPoint => {
  var quaternionToScale = fromEuler(orientation[0] * rad, orientation[1] * rad, orientation[2] * rad, "ZXY");
  ...
  // This has been fixed, but I haven't yet tested it
